...
const Datagraphmateriel = () => {
  ...
  return (
    <div className="">
      <Box m="20px">
    <Header title="line Chart Materiel " subtitle="Materiel Employees Chart" />

      <div id="chart-container" style={{margin: '0 auto' }}>
  ...
  options={{
    ...
    series: [
      ...
      },
      {
        ...
        type: 'line',  color: 'rgba(255, 0, 0, 0.5)',
        yAxis: 0,
        dataLabels: {
          enabled: true,
          format: '{point.name}',
...
export default Datagraphmateriel;
