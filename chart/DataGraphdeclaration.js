...
export const DataGraphdeclaration = () => {
    ...
    return (
      <div>
       <Box m="20px">
    <Header title="Bar Declaration Chart " subtitle="Declaration Employees Chart" />
       <IconButton onClick={handleExportChart} style={{color:'#4cceac',marginLeft:'1020px'}}>
          <GetAppIcon />
        </IconButton>
        <div id="chart-container" style={{ width: '550px', height: '400px', margin: '-50px auto' }}>
        <HighchartsReact
