...
const [fileURL1, setFileURL1] = useState('');
  ...
  const handleFileChange = (e) => {
    ...
    fetch('http://localhost:8089/api/v1/declaration/upload', {
      method: 'POST',
      body: formData,
    })
    ...
    // Update state with the selected file data
    setFile(file);
...
useEffect(() => {
  ...
  const handleUpload = () => {
    ...
    navigate('/Vivolist', { state: { selectedFiles } });
  };
        ...
        const handleDropBoxClick = () => {
          ...
          const defaultFournisseur = 'PETROSUD SARL';
          useEffect(() => {
        ...
        <div className="form">
          <div className="form-content">
            ...
            <div className="circle-container">
              <div className="circle-shadow2">
              
          <LocalGasStationOutlinedIcon style={{ color: 'rgb(251, 83, 67)', fontSize: '60px' }} />
              </div>
            </div>
          </div>
        </div>
